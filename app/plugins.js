...
// //       cache.set('workbench.plugins', id_);
...
// //       const changed = cache.get('workbench.plugin-versions') !== pluginVersions && loaded === total;
// //       cache.set('workbench.plugin-versions', pluginVersions);
...
// // to prevent slowness
// // if (cache.get('workbench.plugins') !== id || process.env.WORKBENCH_FORCE_UPDATE) {
...
//   const pkg = {
//     name: 'workbench-plugins',
//     description: 'Auto-generated from `~/.workbench.js`!',
//     private: true,
//     version: '0.0.1',
//     repository: 'openpilot-community/workbench',
//     license: 'MIT',
//     homepage: 'https://opc.ai/workbench',
//     dependencies
//   };
...
// //       if (!exposed) {
// //         notify('Plugin error!', `Plugin "${basename(path_)}" does not expose any ` + 'Workbench extension API methods');
// //         return;
// //       }
